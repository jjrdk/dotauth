...
//        protected const string MessagePattern = "{ClientId} : {Task}, {Message} : {Operation}";
...
//        {
//            _logger.LogInformation(MessagePattern, evt.ClientId, evt.Task, evt.Message, evt.Operation);
//        }

//        protected void LogError(Event evt)
//        {
//            _logger.LogError(MessagePattern, evt.ClientId, evt.Task, evt.Message, evt.Operation);
//        }

//        protected void LogError(Event evt, EventId evtId, Exception ex)
//        {
//            _logger.LogError(evtId, ex, MessagePattern, evt.ClientId, evt.Task, evt.Message, evt.Operation);
//        }
//    }
//}
