...
public sealed class DynamicRegistrationClient : ClientBase, IDynamicRegistrationClient
{
    ...
    /// <inheritdoc />
    public async Task<Option<DynamicClientRegistrationResponse>> Register(string accessToken, DynamicClientRegistrationRequest request, CancellationToken cancellationToken)
    {
