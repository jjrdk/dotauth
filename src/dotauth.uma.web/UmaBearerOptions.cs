...
/// </summary>
public class UmaBearerOptions : AuthenticationSchemeOptions
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="UmaBearerOptions"/>.
    /// </summary>
    public UmaBearerOptions()
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    /// </summary>
    public new UmaBearerEvents Events
    {
    ...
    /// </summary>
    /// <value>
    /// Defaults to <see cref="Microsoft.Extensions.Configuration.ConfigurationManager.DefaultAutomaticRefreshInterval" />.
    /// </value>
    ...
    /// SecurityTokenValidators can be used when <see cref="SecurityToken"/> needs a <see cref="JwtSecurityToken"/>.
    /// When using TokenHandlers, <see cref="SecurityToken"/> will be a <see cref="JsonWebToken"/>.
    /// </remarks>
