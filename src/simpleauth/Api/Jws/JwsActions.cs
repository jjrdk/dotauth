...
//            if (!string.Equals(jwsHeader.Alg, SecurityAlgorithms.None, StringComparison.CurrentCultureIgnoreCase)
...
//            if (createJwsParameter.Alg != SecurityAlgorithms.None &&
...
//            Uri uri = null;
//            if (createJwsParameter.Alg != SecurityAlgorithms.None && !Uri.TryCreate(createJwsParameter.Url, UriKind.Absolute, out uri))
//            {
//                throw new SimpleAuthException(ErrorCodes.InvalidRequestCode,
