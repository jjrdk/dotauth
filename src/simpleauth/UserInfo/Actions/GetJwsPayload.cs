...
//            var signedResponseAlg = client.UserInfoSignedResponseAlg;
...
//                || signedResponseAlg == SecurityAlgorithms.None)
//            {
...
//            var jwt = await _jwtGenerator.SignAsync(userInformationPayload, signedResponseAlg).ConfigureAwait(false);
//            var encryptedResponseAlg = client.UserInfoEncryptedResponseAlg;
//            var encryptedResponseEnc = client.UserInfoEncryptedResponseEnc;
//            if (encryptedResponseAlg != null)
//            {
//                if (encryptedResponseEnc == null)
//                {
//                    encryptedResponseEnc = SecurityAlgorithms.Aes128CbcHmacSha256;
//                }

//                jwt = await _jwtGenerator.EncryptAsync(jwt,
//                    encryptedResponseAlg,
//                    encryptedResponseEnc).ConfigureAwait(false);
//            }
