...
/// </summary>
/// <seealso cref="Event" />
public sealed record ResourceOwnerAmrAuthenticated : Event
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ResourceOwnerAmrAuthenticated"/> class.
    /// </summary>
    /// <param name="id">The identifier.</param>
    /// <param name="resourceOwnerId"></param>
    /// <param name="amr"></param>
    /// <param name="timestamp">The timestamp.</param>
    public ResourceOwnerAmrAuthenticated(string id, string resourceOwnerId, string? amr, DateTimeOffset timestamp)
        : base(id, timestamp)
    {
