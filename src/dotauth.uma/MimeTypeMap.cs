...
{
    private static readonly Lazy<IDictionary<string, string>> FileTypeMappings = new(BuildMappings);
    ...
    private static IDictionary<string, string> BuildMappings()
    {
        var mappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) {
            ...
            // add those to the dictionary specifically combination of values from Windows 7 Registry and
    ...
    public static string GetMimeType(string extension)
    {
        ...
        return FileTypeMappings.Value.TryGetValue(extension, out var mime) ? mime : "application/octet-stream";
    }

    public static IEnumerable<string> GetMimeTypes()
    {
        return FileTypeMappings.Value.Values.Distinct();
    }

    public static string GetExtension(string mimeType, bool throwErrorIfNotFound = false)
    {
        if (mimeType == null)
        {
        ...
        if (FileTypeMappings.Value.TryGetValue(mimeType, out var extension))
        {
            return extension;
        }
