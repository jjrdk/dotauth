...
public sealed class AuthorizationController : ControllerBase
{
    ...
    private static string GetRedirectionUrl(
        ...
        string? amr,
        DotAuthEndPoints dotAuthEndPoints)
    {
        var uri = request.GetAbsoluteUriWithVirtualPath();
        var partialUri = dotAuthEndPoints switch
        {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(dotAuthEndPoints), dotAuthEndPoints, null)
        };
