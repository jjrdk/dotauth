...
internal static class TokenEndpointHandlers
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var throttled = await EndpointHandlerHelpers.TryThrottleAsync(httpContext, requestThrottle)
            ...
            var tokenRequest = await EndpointHandlerHelpers.BindFromFormAsync<TokenRequest>(httpContext.Request)
                .ConfigureAwait(false);
            ...
            if (tokenRequest.grant_type == null)
            {
                ...
                DotAuthTelemetry.RecordTokenIssueFailure(tokenRequest.grant_type, tokenRequest.client_id,
        ...
        catch (Exception ex)
        {
            ...
            DotAuthTelemetry.RecordTokenIssuanceDuration(
                ...
                null,
                false);
            DotAuthTelemetry.RecordTokenIssueFailure(null, null, ErrorCodes.InternalError);
            return Results.InternalServerError(errorDetails);
        }
    }
