...
public static class DotAuthUiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointRouteBuilder MapDotAuthUiEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapPost("/authenticate/localloginopenid", PasswordUiEndpointHandlers.PostLocalLoginOpenId)
            .WithOrder(-1);
        ...
        endpoints.MapPost("/authenticate/externalloginopenid", PasswordUiEndpointHandlers.ExternalLoginOpenId)
            .WithOrder(-1);
        endpoints.MapGet("/authenticate/logincallbackopenid", PasswordUiEndpointHandlers.LoginCallbackOpenId)
            .WithOrder(-1);
        ...
        endpoints.MapMethods("/pwd/authenticate/openid",
            [HttpMethod.Get.Method, HttpMethod.Post.Method],
            PasswordUiEndpointHandlers.GetAuthenticateOpenId).WithOrder(-1);
        endpoints.MapPost("/pwd/authenticate/localloginopenid", PasswordUiEndpointHandlers.PostLocalLoginOpenId)
            .WithOrder(-1);
        ...
        endpoints.MapPost("/pwd/authenticate/externalloginopenid", PasswordUiEndpointHandlers.ExternalLoginOpenId)
            .WithOrder(-1);
        endpoints.MapGet("/pwd/authenticate/logincallbackopenid", PasswordUiEndpointHandlers.LoginCallbackOpenId)
            .WithOrder(-1);
