...
/// <summary>
/// Defines the DotAuth configuration options.
/// </summary>
public sealed class DotAuthConfiguration
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DotAuthConfiguration"/> class.
    /// </summary>
    ...
    /// </value>
    public string ApplicationName { get; set; } = "DotAuth";
