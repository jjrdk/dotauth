...
namespace SimpleAuth.Tests.Helpers
{
    ...
    public class JsonWebKeyHelperFixture
    {
        ...
        public async Task When_Passing_No_Kid_To_GetJsonWebKey_Then_Exception_Is_Thrown()
        {
            ...
            await Assert.ThrowsAsync<ArgumentNullException>(() => _jsonWebKeyHelper.GetJsonWebKey(null, null))
        ...
        public async Task When_Passing_No_Uri_To_GetJsonWebKey_Then_Exception_Is_Thrown()
        {
            ...
            await Assert.ThrowsAsync<ArgumentNullException>(() => _jsonWebKeyHelper.GetJsonWebKey("kid", null))
                .ConfigureAwait(false);
        }
