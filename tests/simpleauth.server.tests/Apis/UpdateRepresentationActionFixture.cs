...
//            // ACTS & ASSERTS
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _updateRepresentationAction.Execute(null, null, null, "http://localhost/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _updateRepresentationAction.Execute(string.Empty, null, null, "http://localhost/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _updateRepresentationAction.Execute("representation_id", null, null, "http://localhost/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _updateRepresentationAction.Execute("representation_id", new JObject(), null, "http://localhost/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _updateRepresentationAction.Execute("representation_id", new JObject(), string.Empty, "http://localhost/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _updateRepresentationAction.Execute("representation_id", new JObject(), "schema_id", "http://localhost/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _updateRepresentationAction.Execute("representation_id", new JObject(), "schema_id", "http://localhost/{id}", string.Empty)).ConfigureAwait(false);
//        }
