...
//            // ACTS & ASSERTS
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _patchRepresentationAction.Execute(null, null, null, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _patchRepresentationAction.Execute(string.Empty, null, null, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _patchRepresentationAction.Execute("id", null, null, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _patchRepresentationAction.Execute("id", new JObject(), null, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _patchRepresentationAction.Execute("id", new JObject(), string.Empty, null)).ConfigureAwait(false);
//        }
