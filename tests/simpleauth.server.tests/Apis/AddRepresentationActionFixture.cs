...
//            // ACTS & ASSERTS
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _addRepresentationAction.Execute(null, string.Empty, string.Empty, string.Empty, string.Empty)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _addRepresentationAction.Execute(new JObject(), string.Empty, string.Empty, string.Empty, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _addRepresentationAction.Execute(new JObject(), string.Empty, null, string.Empty, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _addRepresentationAction.Execute(new JObject(), string.Empty, "schemaid", string.Empty, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _addRepresentationAction.Execute(new JObject(), string.Empty, "schemaid", null, null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _addRepresentationAction.Execute(new JObject(), string.Empty, "schemaid", "resourcetype", string.Empty)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _addRepresentationAction.Execute(new JObject(), string.Empty, "schemaid", "resourcetype", null)).ConfigureAwait(false);
//        }
