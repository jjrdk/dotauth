...
//            // ACTS & ASSERTS
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _getRepresentationAction.Execute(null, "http://location/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _getRepresentationAction.Execute(string.Empty, "http://location/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _getRepresentationAction.Execute("identifier", "http://location/{id}", null)).ConfigureAwait(false);
//            await Assert.ThrowsAsync<ArgumentNullException>(() => _getRepresentationAction.Execute("identifier", "http://location/{id}", string.Empty)).ConfigureAwait(false);
//        }
